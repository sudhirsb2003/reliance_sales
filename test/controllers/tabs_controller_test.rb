...
class TabsControllerTest < ActionController::TestCase
  ...
  test "should create tab" do
    assert_difference('Tab.count') do
      post :create, tab: { mac_address: @tab.mac_address, name: @tab.name, pincode: @tab.pincode, tab_code: @tab.tab_code, zone_id: @tab.zone_id }
    end
  ...
  test "should update tab" do
    patch :update, id: @tab, tab: { mac_address: @tab.mac_address, name: @tab.name, pincode: @tab.pincode, tab_code: @tab.tab_code, zone_id: @tab.zone_id }
    assert_redirected_to tab_path(assigns(:tab))
  end
